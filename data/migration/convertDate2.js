...
function setScheduleDay(schedule, courseType, indexSchedule){
  ...
  courseType.schedules[indexSchedule].dayEnd = getNewIsoDate(day, hour);
}
          ...
          teacher.course.courseTypes.map(function(courseType){
            if(courseType.schedules){
              courseType.schedules.map(function(schedule, indexSchedule){
                setScheduleDay(schedule, courseType, indexSchedule);
